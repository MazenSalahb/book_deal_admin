...
class ApprovedBooksScreen extends StatefulWidget {
  const ApprovedBooksScreen({super.key});

  @override
  State<ApprovedBooksScreen> createState() => _ApprovedBooksScreenState();
}

class _ApprovedBooksScreenState extends State<ApprovedBooksScreen> {
  Future<List<BookModel>>? future;

  void getPendingBooks() {
    future = BookService().getApprovalBooks();
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Approved Books'),
      ),
      body: Padding(
